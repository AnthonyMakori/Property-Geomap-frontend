                        ...
                        <Grid>
                            <Grid.Col lg={3}>
                                <Stack>
                                    ...
                                    <Paper {...PAPER_PROPS}>
                                        <Text size="lg" fw={600} mb="md">Unit Types</Text>
                                        <Group spacing="xs">
                                             <Badge variant="filled" color="primary.8"> Studio </Badge>
                                             <Badge variant="filled" color="primary.8"> One Bedroom </Badge>
                                             <Badge variant="filled" color="primary.8"> Two Bedroom </Badge>
                                             <Badge variant="filled" color="primary.8"> Bedsitter </Badge>
                                        </Group>
                                    </Paper>
                                    <Paper {...PAPER_PROPS}>
                                        <Stack>
