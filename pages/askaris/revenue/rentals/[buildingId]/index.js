...
import {
    ...
    Input,
    Table,
    Title, UnstyledButton, useMantineTheme, Select, Menu
} from "@mantine/core";
...
import {
    ...
    IconArrowBack,
    IconChevronDown,
    IconBusinessplan, IconCoins,IconTrash , IconDotsVertical, IconPin, IconEye, IconPencil
                        ...
                        <Grid>
                            <Grid.Col lg={3}>
                                <Stack>
                                    <Paper p="md" shadow='md' radius="md">
                                        ...
                                        <Text ta="center" c="dimmed" fz="xs">
                                        Landlord: { building?.landlord?.name ?? "Admin" }
                                        </Text>
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    <Link
                                        href={`/askaris/revenue/addother/${item?.id}?buildingId=${buildingId}`}
                                    >
                                        <Menu.Item
                                        color="blue"
