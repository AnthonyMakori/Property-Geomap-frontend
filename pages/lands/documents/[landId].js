...
import { getLandDocuments } from '../../../store/properties/buildings/buildings-slice';
...
function LandDocuments() {
    ...
    const itemsStatus = useSelector((state) => state.buildings.getLandDocumentsStatus);
    const items = useSelector((state) => state.buildings.getLandDocuments);
    ...
    useEffect(() => {
      ...
      store.dispatch(getLandDocuments(params));
                    ...
                    <Flex
                        ...
                        <Paper p="md" shadow='md' radius="md">
                            <Group position="apart" mb="md">
                                <Text fz="lg" fw={600}>Land Documents</Text>
                                <TextInput
                                    label="Search"
                                    placeholder="Search"
                                    value={searchTerm}
