...
function CreateBusiness() {
    ...
    //setLandloardSign
    const [landloardSign, setLandloardSign] = useState('');   
    const [tenantSign, setTenantSign] = useState(''); 
                        ...
                        <Paper p="md" shadow="md">
                            ...
                            />
                                    ...
                                    <TextInput
                                        ...
                                        onChange={e => setTenantSign(e.target.value)}
                                        // placeholder="Eg. Terms"
                                    />
                                    <TextInput
                                        label="Landlord Signature"
                                        onChange={e => setLandloardSign(e.target.value)}
                                        // placeholder="Eg. 34565789"
                                    />
                                ...
                                <Box sx={{width: 'auto'}}>
                                    ...
                                    {/* <Button ml="xs" color='green' variant='outline' > Add Footer </Button>
                                    <Button ml="xs" color='indigo' variant='outline' > Preview </Button> */}
                                </Box>
                            </Stack>
                        </Paper>
                    </Stack>
