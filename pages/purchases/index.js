...
function Expenses() {
    ...
    const purchasesStatus = useSelector((state) => state.accounts.getPurchasesStatus);
    const purchases = useSelector((state) => state.accounts.getPurchases);
  
    const isLoading = purchasesStatus === 'loading';
  ...
  const printExpense = async (itemId) => {
    ...
    const endpoint = `${API_URL}/purchases/download/${itemId}`;
                    ...
                    <Flex
                        ...
                        <Paper p="md" shadow='md' radius="md">
                            <Group position="apart" mb="md">
                                <Text fz="lg" fw={600}>Purchases</Text>
                                <TextInput
                                    label="Search"
                                    placeholder="Search"
                                    value={searchTerm}
                            ...
                            <td>Ksh. {item?.amount * item?.quantity ?? "0"}</td>
                            <td>                               
                            ...
                            <ApprovalModal item={item} origin="purchases" />
