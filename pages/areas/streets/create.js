...
function CreateBusiness() {
    ...
    const submit = async (e) => {
        ...
        try {
            const response = await fetch(`${API_URL}/locations/store-street`, {
                method: 'POST',
                headers: {
                    ...
                    <Flex
                        ...
                        <Paper p="md">
                            <Stack>
                                ...
                                <Box sx={{width: 'auto'}}>
                                    <Button onClick={submit} loading={isSubmitting}>Create Street</Button>
                                </Box>
                            </Stack>
                        </Paper>
                    </Stack>
