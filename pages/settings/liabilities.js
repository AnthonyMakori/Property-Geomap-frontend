...
import AddLiabilityModal from '../../components/Settings/add-liability-modal';
...
function Liabilities() {
  ...
  const itemStatus = useSelector((state) => state.reports.getLiabilitiesStatus);
  const items = useSelector((state) => state.reports.getLiabilities);
            ...
            <AppLayout>
                <Container fluid>
                    ...
                    <Flex
                            ...
                            >
                                <Stack>
                                    <Title order={3}>Liabilities</Title>
                                </Stack>
                                <AddLiabilityModal />
                            </Flex>
                        <Paper p="md" shadow='md' radius="md">
                            <Group position="apart" mb="md">
                                <Text fz="lg" fw={600}>Liabilities</Text>
                                <TextInput
                                    label="Search"
                                    placeholder="Search"
                                />
