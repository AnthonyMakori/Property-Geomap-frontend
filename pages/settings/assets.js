...
import { getAssets } from '@/store/reports/reports-slice';
import AddAssetModal from '@/components/Settings/add-asset-modal';
...
function Assets() {
  ...
  const itemStatus = useSelector((state) => state.reports.getAssetsStatus);
  const items = useSelector((state) => state.reports.getAssets);
