            ...
            <AppLayout>
                <Container fluid>
                    ...
                    <Flex
                            ...
                            >
                                <Stack>
                                    <Title order={3}>Access Groups</Title>
                                </Stack>
                                <AddAccessControlRoleModal />
                            </Flex>
                        <Paper p="md" shadow='md' radius="md">
                            <Group position="apart" mb="md">
                                <Text fz="lg" fw={600}>Access Groups</Text>
                                <TextInput
                                    label="Search"
                                    placeholder="Search"
                                    value={searchTerm}
                            ...
                            <td>
                                ...
                                <Link href={`/settings/access-control/${item?.id}`}>
                                <Button leftIcon={<IconShieldLock size={14} />} size='xs'>Permissions</Button>
                                </Link>
                            </td>
