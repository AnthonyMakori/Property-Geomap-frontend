      ...
      <Container fluid>
        <Stack spacing="lg">
          <Card>
            ...
            >
              <Stack>
                <Title order={4}>Basic Statement of Account</Title>
              </Stack>
          ...
          />
              ...
              <h4 className="mb-0 mt-0 text-primary">Monthly Invoice & Payment Statement (KES)</h4>
              <Table>
              ...
              <h4 className="mb-0 mt-0 text-primary">New Leases</h4>
              <Table>
                <thead className="bg-gray-50">
                  <tr>
                    <th scope="col" className="th-primary">
